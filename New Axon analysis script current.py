...
# Elasticsearch credentials and setup
...
# Paths
response_json_path = r"D:\Axon python scripts\Documentation\Current data scripts\response_current.json"
...
# Your aggregation query (as a Python dict)
aggs_query = {
  "size": 0,
  "aggs": {
    "states": {
...
print(f"Elasticsearch response saved to {response_json_path}")
